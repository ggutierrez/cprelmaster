...
namespace MPG { namespace VarImpl {
	...
	return ds_.zero();
      ...
      /// Returns the domain space associated to the manager
      DomainSpace& domain(void) {
	return ds_;
      }
	...
	*/
    ...
    /**
     * \brief Returns the domain space associated to the manager.
     * \ingroup DomRepr
     *
     * The domain space is where the actual representation of
     * relations takes place.
     */
    inline
    DomainSpace& domain(void) {
      return BddManager::instance()->domain();
    }
    /**
